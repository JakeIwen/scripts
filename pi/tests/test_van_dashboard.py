...
class DashboardRouteTests(unittest.TestCase):
    def test_index_and_manifest(self):
        ...
        self.assertIn(b"networkState('ubnt-wifi-dot',true)", javascript.data)
        self.assertIn(b"networkState('ubnt-radio-dot',connected)", javascript.data)
        ...
        self.assertIn(b".mwan-list{display:flex;flex-direction:column", stylesheet.data)
